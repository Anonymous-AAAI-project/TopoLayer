...
import datetime
import os
import models.TopoPointNet2_headversion as models
...
def parse_arg():
    ...
    parser.add_argument("--model", type=str, default="PointNet2ClsMsg", help="model name [default: pointMLP]")
    ...
    parser.add_argument("--min_lr", type=float, default=0.005, help="min learning rate")
